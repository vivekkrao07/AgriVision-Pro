export const getDiseaseInfo = (predictionLabel) => {
  ...
  if (label.includes('healthy')) {
    return {
      ...
      severity: 'Low',
      impact: 'Minimal',
      aiExplanation: 'The AI detected uniform green pigment and smooth leaf surface without any irregular pustules or discoloration patterns typical of fungal growth.',
      maintenance: [
    ...
    return {
      ...
      severity: 'High',
      impact: 'Severe',
      aiExplanation: 'The AI identified linear yellow-to-orange stripes formed by uredinia (pustules) along the leaf veins, which is a hallmark signature of yellow rust.',
      maintenance: [
    ...
    return {
      ...
      severity: 'Medium',
      impact: 'Moderate',
      aiExplanation: 'The model flagged scattered, circular-to-oval orange-brown pustules that erupt through the epidermis, primarily on the upper leaf surface.',
      maintenance: [
        'Apply an approved foliar fungicide to protect the upper leaves (especially the flag leaf).',
     ...
     return {
      ...
      severity: 'Medium',
      impact: 'Moderate',
      aiExplanation: 'The AI recognized necrotic, lens-shaped lesions with dark specks (pycnidia) in the center, which are key diagnostic features for Septoria.',
      maintenance: [
    ...
    return {
      ...
      severity: 'Medium',
      impact: 'Moderate',
      aiExplanation: 'The AI detected irregular patterns of chlorosis or necrosis that deviate from typical healthy wheat leaf morphology.',
      maintenance: [
